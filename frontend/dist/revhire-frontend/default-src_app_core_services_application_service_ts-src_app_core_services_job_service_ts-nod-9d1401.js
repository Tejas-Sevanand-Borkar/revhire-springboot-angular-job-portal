"use strict";
(self["webpackChunkrevhire_frontend"] = self["webpackChunkrevhire_frontend"] || []).push([["default-src_app_core_services_application_service_ts-src_app_core_services_job_service_ts-nod-9d1401"],{
...
class ApplicationService {
  constructor(http) {
    this.http = http;
    this.API_URL = 'http://localhost:8080/api/applications';
  }
  getEmployerApplications() {
    return this.http.get(`${this.API_URL}/employer`);
  }
  getApplicationById(id) {
    return this.http.get(`${this.API_URL}/${id}`);
  }
  applyForJob(jobId, coverLetter) {
    return this.http.post(`${this.API_URL}/apply/${jobId}`, {
      coverLetter
    });
  }
  ...
  bulkUpdateApplicationStatus(applicationIds, status, comment) {
    return this.http.put(`${this.API_URL}/bulk-status`, {
      applicationIds,
      status,
      comment
    });
  ...
  withdrawApplication(id, reason) {
    return this.http.patch(`${this.API_URL}/${id}/withdraw`, {
      reason
    });
  }
  getApplicationsByJob(jobId) {
    return this.http.get(`${this.API_URL}/job/${jobId}`);
  }
  getApplicationsByJobSeeker(jobSeekerId) {
    return this.http.get(`${this.API_URL}/seeker/${jobSeekerId}`);
  }
  getApplicationsByEmployer(employerId) {
    return this.http.get(`${this.API_URL}/employer/${employerId}`);
  }
  getAllApplications() {
    return this.http.get(`${this.API_URL}`);
  }
  getApplicationStats() {
    return this.http.get(`${this.API_URL}/employer/stats`);
  }
  acceptApplication(id) {
    return this.http.put(`${this.API_URL}/${id}/accept`, {});
  }
  ...
  static {
    this.ɵfac = function ApplicationService_Factory(t) {
      return new (t || ApplicationService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient));
    };
  }
  static {
...
class JobService {
  constructor(http) {
    this.http = http;
    this.API_URL = 'http://localhost:8080/api/jobs';
  }
  getJobs() {
    return this.http.get(`${this.API_URL}`);
  }
  ...
  updateJob(id, job) {
    return this.http.put(`${this.API_URL}/${id}`, job);
  }
  deleteJob(id) {
  ...
  getJobsByLocation(location) {
    return this.http.get(`${this.API_URL}/location/${location}`);
  }
  getJobsByType(jobType) {
    return this.http.get(`${this.API_URL}/type/${jobType}`);
  }
  getJobsByWorkLocation(workLocation) {
    return this.http.get(`${this.API_URL}/work-location/${workLocation}`);
  }
  getEmployerJobs() {
    return this.http.get(`${this.API_URL}/employer`);
  }
  ...
  createJobFromDialog(jobData) {
    ...
    return this.http.post(this.API_URL, jobPayload);
  }
  static {
...
//# sourceMappingURL=default-src_app_core_services_application_service_ts-src_app_core_services_job_service_ts-nod-9d1401.js.map